...
- We also have some exploratory hypothesis for resting state recordings. There is some, although messy, evidence that asymmetry in the PFC may be an indicator of personality.
...
- We currently plan to analyze the data in at least two ways and compare their pros and cons.
  - Waveform average
  - GLM
